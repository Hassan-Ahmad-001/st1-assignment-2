# Stage 2 From Problems to Requirements
...
- ☑ **Functional** — The system shall retain canceled appointments.
...
| Receptionists create appointments.        | Confirmed                       | Supported by the client brief (staff report duplicate bookings, implying booking is a staff task).                                                 |
