...
Before using AI, I built a basic SmartCare appointment prototype using Python. I first identified the information that needed to be stored: patient name, practitioner name and appointment time. I then used a list, dictionaries and functions to store and display appointments. This helped me understand the basic structure of the problem rather than relying on AI to build everything immediately.

AI helped me understand how the Python function worked, why a dictionary was useful for representing an appointment, and how validation could be added. It also helped identify limitations and suggest controlled improvements.
