# Stage 1 Activity - Why Software Engineering Still Matters
...
1. Roughly how many patients and appointments does the clinic handle per day/week, and how many staff members would use the system?
...
| AI suggestion                | Client evidence?                  | In scope? | Decision                                                                                                                   |
|------------------------------|-----------------------------------|-----------|----------------------------------------------------------------------------------------------------------------------------|
